...
func (b *BottomBar) Setup(board *Board) {
	...
	b.layoutNums.SetLayout(eui.NewGridLayout(board.dim.W, board.dim.H, 1))
	b.layoutActs.Add(eui.NewLabel(Title))
	b.layoutActs.Add(eui.NewLabel(board.dim.String()))
	diffText := eui.NewLabel("")

Примеры использования комплекса виджетов, для быстрого встраивания в игры. 
...
Примеры: 
  * [выравнивание текста в текстовой метке](examples/align/main.go).
  * [аналоговые часы](examples/analog_clock/main.go). Реализуется настройка темы, виджеты чекбокс(тумблер показать миллисекундную стрелку), топбар(выход со сцены, секундомер нахождения в приложении) 
  * [диалог выбор горячих клавиш](examples/hotkey_select/main.go)
  * [контейнер с прокруткой списков(метка текста, кнопки, чекбоксы, многострочный текст)](examples/listview/main.go)
  ...
  * [кальулятор выбора цвета](examples/rgb_calculator/main.go)
  * [таблица эксель](examples/spreadsheet/main.go)(только формула сложения)
  * [7GUIs 6 задач из 7](examples/7Guis/main.go)
